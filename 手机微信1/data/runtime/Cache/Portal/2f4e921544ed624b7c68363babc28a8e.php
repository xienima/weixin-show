							...
							<td>
								<div style="text-align: center;">
									...
									<a href='javascript:void(0);' onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
										<?php if(empty($smeta['thumb'])): ?><img src="/thinkcmf/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id='thumb_preview' width='135' height='113' style='cursor: hand' />
										<?php else: ?>
